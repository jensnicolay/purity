...
(let ((approximate '<undefined>))
  (let ((A '<undefined>))
    (let ((mulAv '<undefined>))
      (let ((mulAtV '<undefined>))
        (let ((mulAtAv '<undefined>))
          (let ((main '<undefined>))
            (let ((_$56 (set! approximate (lambda (_n6)
                                                        ...
                                                        (letrec ((__loop113 (lambda (_i14)
                                                          ...
                                                          (let ((_$54 (__loop113 0)))
                                                            (let ((_p55 (/ _vBv9 _vV10)))
                                                              (sqrt _p55))))))))))))))
              (let ((_$65 (set! A (lambda (_i15 _j16)
                                    (let ((_p57 (+ _i15 _j16)))
                                      (let ((_p58 (+ _i15 _j16)))
                                        (let ((_p59 (+ _p58 1)))
                                          (let ((_p60 (* _p57 _p59)))
                                              ...
                                              (let ((_p62 (+ _p61 _i15)))
                                                (let ((_p63 (+ _p62 1)))
                                                  (let ((_p64 (exact->inexact _p63)))
                                                    (/ 1.0 _p64)))))))))))))
                (let ((_$78 (set! mulAv (lambda (_n17 _v18 _av19)
                                                                        ...
                                                                        (letrec ((__loop322 (lambda (_j23)
                                                                          ...
                                                                          (let ((_$76 (__loop322 0)))
                                                                            (let ((_p77 (+ _i21 1)))
                                                                              (__loop220 _p77))))))))))
                                            (__loop220 0))))))
                  (let ((_$91 (set! mulAtV (lambda (_n24 _v25 _atv26)
